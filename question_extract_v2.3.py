...
QUESTION_WORDS = [
    ...
    "是什么", "什么","吗"  # v2.2：补“什么”以覆盖“...是什么/什么作用”
]
...
# v2.3：课程信号词（用于允许“只有困惑词但确实在问课程对象”的句子通过）
COURSE_SIGNAL_WORDS = [
    # 关键控制结构/关键字
...
def main():
    ...
    parser.add_argument("--out", default="question_candidates_v2_3.json", help="output json filename")
